...
if (!empty($product_tabs)) : ?>
    <div class="woocommerce-tabs wc-tabs-wrapper">
        ...
        foreach ($product_tabs as $key => $product_tab) :
            ?>
            <div class="zoo-group-accordion <?php if ($i == 0) {
                echo esc_attr('accordion-active');
            } ?>">
                <h3 class="tab-heading"><?php echo apply_filters('woocommerce_product_' . $key . '_tab_title', esc_html($product_tab['title']), $key); ?>
