<?php
/**
 * Zoo_Customize_Control_Text_Align_No_Justify
 *
 * @package  Zoo_Theme\Core\Customize\Classes\Controls
 *
 */
final class Zoo_Customize_Control_Text_Align_No_Justify extends Zoo_Customize_Control_Default
{
    /**
     * Print template
     */
    ...
    {
        ?>
        <script type="text/html" id="tmpl-zoo-customize-control-text_align_no_justify">
        <#
        var required = '';
