...
<div id="on-sale-<?php echo($item_number);?>" class="item ui-draggable">
    <div class="item-top">
        ...
        <div class="item-title ui-draggable-handle">
            <h3><?php esc_html_e('On Sale','clever-layered-navigation')?><span class="in-item-title"></span></h3>
        </div>
    </div>
    <div class="item-inside">
        <form method="post">
            <div class="item-content">
                <p>
                    <label for="on-sale-<?php echo($item_number);?>-title"><?php esc_html_e('Title','clever-layered-navigation')?></label>
                ...
                if ($filter_view_style == 'vertical'):
                    ?>
                    <p>
                        <label for="on-sale-<?php echo $item_number?>-vertical-always-visible">
                            <input class="widefat " id="on-sale-<?php echo $item_number ?>-vertical-always-visible"
                                   name="on-sale[<?php echo $item_number ?>][vertical-always-visible]" value="1"
            ...
            <div class="item-control-actions">
                ...
                <div class="alignright">
                    <input name="saveitem" id="on-sale-<?php echo($item_number);?>-saveitem" class="button button-primary item-control-save right" value="<?php esc_attr_e('Save','clever-layered-navigation')?>" type="submit">			<span class="spinner"></span>
                </div>
                <br class="clear">
            </div>
        </form>
    ...
    <div class="item-description">
        <?php esc_html_e('Show only product on sale after filter','clever-layered-navigation')?>
    </div>
</div>
